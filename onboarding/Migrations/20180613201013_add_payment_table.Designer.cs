...
namespace onboarding.Migrations
{
    ...
    [Migration("20180613201013_add_payment_table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onboarding.Models.Contract", b =>
                {
                    ...
                    b.HasIndex("EnrollmentStepId")
                        .IsUnique()
                        .HasFilter("[EnrollmentStepId] IS NOT NULL");
            ...
            modelBuilder.Entity("onboarding.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("BilletUrl");
            ...
            modelBuilder.Entity("onboarding.Models.Contract", b =>
                {
                    ...
                    b.HasOne("onboarding.Models.EnrollmentStep", "EnrollmentStep")
                        .WithOne("Contracts")
                        .HasForeignKey("onboarding.Models.Contract", "EnrollmentStepId");
                });
            ...
            modelBuilder.Entity("onboarding.Models.FinanceData", b =>
                {
                    ...
                    b.HasOne("onboarding.Models.EnrollmentStep", "EnrollmentStep")
                        .WithOne("FinanceData")
                        .HasForeignKey("onboarding.Models.FinanceData", "EnrollmentStepId");
            ...
            modelBuilder.Entity("onboarding.Models.Payment", b =>
                {
                    b.HasOne("onboarding.Models.Enrollment", "Enrollment")
                        .WithOne("Payment")
                        .HasForeignKey("onboarding.Models.Payment", "EnrollmentId");
            ...
            modelBuilder.Entity("onboarding.Models.PersonalData", b =>
                {
                    ...
                    b.HasOne("onboarding.Models.EnrollmentStep", "EnrollmentStep")
                        .WithOne("PersonalData")
                        .HasForeignKey("onboarding.Models.PersonalData", "EnrollmentStepId");
