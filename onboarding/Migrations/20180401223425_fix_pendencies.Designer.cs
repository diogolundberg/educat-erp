...
namespace onboarding.Migrations
{
    ...
    [Migration("20180401223425_fix_pendencies")]
    partial class fix_pendencies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Onboarding.Models.EnrollmentPendency", b =>
                {
                    b.Property<int>("EnrollmentId");

                    b.Property<int>("PendencyId");

                    b.HasKey("EnrollmentId", "PendencyId");

                    b.HasIndex("PendencyId");

                    b.ToTable("EnrollmentPendency");
                });
            ...
            modelBuilder.Entity("Onboarding.Models.EnrollmentPendency", b =>
                {
                    b.HasOne("Onboarding.Models.Enrollment", "Enrollment")
                        .WithMany("EnrollmentPendencies")
                        .HasForeignKey("EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Onboarding.Models.Pendency", "Pendency")
                        .WithMany()
